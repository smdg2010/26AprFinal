/**
 * WSDSTWrapperSoapBindingStub.java
 *
...
public class WSDSTWrapperSoapBindingStub extends org.apache.axis.client.Stub implements WSDSTWrapper {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://test", "DemandSignature"));
    ...
    public WSDSTWrapperSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public WSDSTWrapperSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public WSDSTWrapperSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName = new javax.xml.namespace.QName("http://test", "Demand");
            ...
            qName = new javax.xml.namespace.QName("http://test", "DemandSignature");
            cachedSerQNames.add(qName);
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {podSignature});
  ...
  throw axisFaultException;
    ...
    public DemandSignature setHashTable(IDemand poIdObj) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
            throw new org.apache.axis.NoEndPointException();
        }
        org.apache.axis.client.Call _call = createCall();
